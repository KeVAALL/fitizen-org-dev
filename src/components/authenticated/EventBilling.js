        ...
        <section className="layout-pb-md">
          <div className="container">
            <div className="row y-gap-30">
              ...
              <div className="col-xl-12 col-md-12">
                <div className="py-30 px-30 border-light rounded-8 bg-light-4">
                  <div className="row y-gap-20 justify-between items-center">
                    <div className="col-lg-5">
                      <div className="fw-500 lh-14 text-11 text-light-1">
                        Next Payout On (Only for transactions till 3 September)
                      </div>
            ...
            <div className="row pt-30">
              <div className="col-xl-3 col-md-6">
                <div className="py-20 px-15 border-light rounded-16 bg-white -hover-shadow">
                ...
                >
                  <div className="py-20 px-15 border-light rounded-16 bg-white -hover-shadow">
                    <div className="row justify-between items-center">
                      ...
                      <div className="col-7 pl-0">
                        <div className="fw-600 lh-14 text-13">Bank Details</div>
                      </div>
                    </div>
                  </div>
                </a>
              ...
              <div className="col-xl-3 col-md-6">
                <div className="py-20 px-15 border-light rounded-16 bg-white -hover-shadow">
                  <div className="row justify-between items-center">
                    ...
                    <div className="col-7 pl-0">
                      <div className="fw-600 lh-14 text-13">Transactions</div>
                    </div>
                  </div>
                </div>
              </div>
